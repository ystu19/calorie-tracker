...
const error = ref("");
let loadRequestId = 0;
const blank = () => ({ name: "", base_amount: 100, unit: "g", protein: "", fat: "", carbs: "", has_alcohol: false, alcohol_abv: 0, nutrition_source: "manual", estimated: false });
